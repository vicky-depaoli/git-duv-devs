INSERT INTO Autor (dni, nombre, apellido, fecha_nacimiento, cantidad_libros) VALUES
('11111111A', 'Gabriel', 'García Márquez', '1927-03-06', 5),
('22222222B', 'Isabel', 'Allende', '1942-08-02', 1),
('33333333C', 'Julio', 'Cortázar', '1914-08-26', 1),
('44444444D', 'J.K.', 'Rowling', '1965-07-31', 7),
('55555555E', 'Stephen', 'King', '1947-09-21', 2);

INSERT INTO Libro (isbn, nombre, fecha_publicacion, autor_id) VALUES
